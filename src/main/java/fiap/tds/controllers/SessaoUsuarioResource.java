...
import fiap.tds.services.SessaoUsuarioService;
...
public class SessaoUsuarioResource {
    ...
    private static final Logger logger = LogManager.getLogger(SessaoUsuarioResource.class);
    private final SessaoUsuarioService service = new SessaoUsuarioService();
    ...
    @Produces(MediaType.APPLICATION_JSON)
    public Response logoutSessao(ResponseSessaoUsuarioDto dto) {
